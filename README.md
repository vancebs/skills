...
| [skill-guide](skill-guide/) | Skill 使用指引。解决能力较弱的模型常见问题：路径错误（SKILL_DIR vs SKILL_WORKSPACE）、配置文件未加载、跨平台兼容性、shell 引号、环境变量丢失等。包含通用诊断脚本和快速参考卡。 | [📖 README](skill-guide/README.md) | `npx skills add https://github.com/vancebs/skills --skill skill-guide` |
